...
class SalesReport(Toplevel):

    def __init__(self, master):
        Toplevel.__init__(self, master)
        self.title("Sales Report")
        self.exp_acc_label = ttk.Label(self, text="SALES", font=("Times New Roman", 35, "bold"))
        ...
        self.columns = ("date", "inv_no", "cus_no", "i_no", "ced")
        self.headings = ("Date", "Invoice No", "Customer No", "Item No", "Amount GH¢")
    ...
    def generate_report_btn_command(self):
        ...
        for data in s_data.report(self.start_date_entry.get(), self.end_date_entry.get()):
            print(data)
        ...
        total_amt = (s_data.sum_amt(self.start_date_entry.get(), self.end_date_entry.get()))
