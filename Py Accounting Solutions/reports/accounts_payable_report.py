...
class AccountsPayableReport(Toplevel):

    def __init__(self, master):
        Toplevel.__init__(self, master)
        self.title("Accounts Payable Report")
        self.exp_acc_label = ttk.Label(self, text="ACCOUNTS PAYABLE", font=("Times New Roman", 35, "bold"))
    ...
    def generate_report_btn_command(self):
        ...
        for data in creditor.report(self.start_date_entry.get(), self.end_date_entry.get()):
            print(data)
        ...
        total_amt = (creditor.sum_amt(self.start_date_entry.get(), self.end_date_entry.get()))
