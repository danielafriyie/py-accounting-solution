...
class AccountsReceivableReport(Toplevel):

    def __init__(self, master):
        Toplevel.__init__(self, master)
        self.title("Accounts Receivable Report")
        self.exp_acc_label = ttk.Label(self, text="ACCOUNTS RECEIVABLE", font=("Times New Roman", 35, "bold"))
        ...
        self.columns = ("date", "inv_no", "a_no", "i_code", "des", "ced")
        self.headings = ("Date", "Invoice No", "Account No", "Item Code", "Description", "Amount GH¢")
    ...
    def generate_report_btn_command(self):
        ...
        for data in debtor.report(self.start_date_entry.get(), self.end_date_entry.get()):
            print(data)
        ...
        total_amt = (debtor.sum_amt(self.start_date_entry.get(), self.end_date_entry.get()))
